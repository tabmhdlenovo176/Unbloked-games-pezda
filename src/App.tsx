...
const BACKUP_GAMES: Game[] = [
  {
    ...
    "controls": "Arrow Keys on desktop or On-Screen arrow buttons on mobile.",
    "rating": "4.8",
    "plays": "14.2K",
    "accentColor": "#10b981",
  ...
  },
  {
    ...
    "controls": "Keyboard Arrows on desktop or On-Screen buttons on mobile.",
    "rating": "4.7",
    "plays": "18.5K",
    "accentColor": "#f59e0b",
    "difficulty": "Hard"
  },
  {
    ...
    "controls": "Move Mouse or Left/Right arrows on Desktop to slide paddle.",
    "rating": "4.9",
    "plays": "22.1K",
    "accentColor": "#ec4899",
    "difficulty": "Medium"
  },
  {
    ...
    "controls": "W/S keys or Arrow Keys on Desktop, On-Screen buttons on Mobile.",
    "rating": "4.5",
    "plays": "9.8K",
    "accentColor": "#3b82f6",
  ...
  },
  {
    ...
    "accentColor": "#facc15",
    "controls": "Press SPACEBAR, click inside container, or tap mobile triggers.",
    "rating": "4.6",
    "plays": "31.4K",
  ...
  },
  {
    "id": "basket-random",
    "title": "Basket Random",
    "description": "Hilarious 2v2 floppy ragdoll basketball! Press and hold jump to launch your players into the air while tilting, and release to shoot. Face an AI or challenge a friend in local 2-Player mode with slides, slippery ice courts, and extreme medicine balls!",
    "category": "Sports",
    "iframeUrl": "/games/basket-random/index.html",
    "thumbnail": "/games/basket-random/thumbnail.jpg",
    "controls": "WASD keys for Player A, Arrow keys for Player B. Charge jump and release to launch the ball.",
    "rating": "4.9",
    "plays": "27.4K",
    "accentColor": "#f59e0b",
    "difficulty": "Easy & Goofy"
  }
];
